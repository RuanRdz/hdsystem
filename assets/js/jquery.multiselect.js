...
(function ($, undefined) {
  ...
  $.widget("ech.multiselect", {
    ...
    options: {
      ...
      btnMostrarTodos: 'Mostrar Todos',
      btnMostrarSelecionados: 'Mostrar Selecionados',
      noneSelectedText: '--- Selecione ---',
      showCheckAll: false,
      showUncheckAll: false,
      showBtnMostrarTodos: false,
      showBtnMostrarSelecionados: false,
      ...
      this.headerLinkContainer = $('<ul />')
              ...
              .html(function () {
                if ((o.header === true) && (o.btnAll === true) && (o.multiple)) {
                  ...
                  if (!!o.showBtnMostrarTodos) {
                    header_lis += '<li class="'+ o.marginClassBtnMostrarTodos +'"><a class="'+ o.showBtnMostrarTodos +'" href="#"><span>' + o.btnMostrarTodos + '</span></a></li>';
                  } else if (!!o.showBtnMostrarSelecionados) {
                    header_lis += '<li class="' + '"><a class="ui-multiselect-show-selected ' + o.showBtnMostrarSelecionados +'" href="#"><span>' + o.btnMostrarSelecionados + '</span></a></li>';
                  }
                  return header_lis;
                } else if((!o.multiple) && (!!o.showBtnMostrarTodos)){
                  var header_lis = '<li><a class="'+ o.showBtnMostrarTodos +'"><span>' + o.btnMostrarTodos + '</span></a></li>';
                  return header_lis;
    ...
    refresh: function (init) {
      ...
      if (this.options.header) {
        if (!this.options.multiple && !this.options.showBtnMostrarTodos) {
...
//      this._buildOptionList(el, $dropdown);
    ...
    _bindHeaderEvents: function () {
      ...
      this.header.delegate('a', 'click.multiselect', function (e) {
        ...
        if ($this.hasClass('ui-multiselect-close')) {
          ...
          self.uncheckAll();
        } else if($this.hasClass('ui-multiselect-show-selected')) {
          $this.removeClass('ui-multiselect-show-selected').addClass('ui-multiselect-show-all');
          $('span', $this).html('Mostrar Todos');
          self.showSelected();
        } else if($this.hasClass('ui-multiselect-show-all')) {
          $this.removeClass('ui-multiselect-show-all').addClass('ui-multiselect-show-selected');
          $('span', $this).html('Mostrar Selecionados');
          self.showAll();
        }
        e.preventDefault();
    ...
    showSelected: function () {
      this.labels.find('input').each(function(iIndex, eElement) {
        if(!$(eElement).is(':checked')) {
          $(eElement).hide();
          $(eElement).parents('li').hide();
        }
      });
    },
    hideAll: function () {
