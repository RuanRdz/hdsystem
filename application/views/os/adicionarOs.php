            ...
            <div class="tab-pane active" id="tab1">
              <div class="span12" id="divCadastrarOs">
                ...
                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                  ...
                  <div class="span12" style="padding: 1%; margin-left: 0; display:flex; text-align: center; align-items: center; justify-content: center;">
                    ...
                    <a href="<?php echo base_url() ?>os" class="button btn btn-mini btn-warning" style="max-width: 160px">
