    ...
    <div class="row-fluid" style="width: 100vw;height: 100vh;display: flex;align-items: center;justify-content: center">
            <div class="widget-box" style="align-items: center;padding: 0 15px">
                ...
                <div class="widget-content nopadding tab-content">
                    ...
                    <form action="<?php echo base_url() . "mine/gerarTokenResetarSenha" ?>" id="formCliente" method="post" class="form-horizontal">
                        ...
                        <div class="form-actions" style="background-color:transparent;border:none;padding: 10px;margin-top: 15px">
                            <div class="span12">
                                <div class="span6 offset3" style="display:flex;justify-content: center">
                                    ...
                                    <a href="<?php echo base_url() ?>mine" id="" class="button btn btn-warning"><span class="button__icon"><i class='bx bx-lock-alt'></i></span><span class="button__text2">Acessar</span></a>
                                </div>
                            </div>
                        </div>
                    </form>
