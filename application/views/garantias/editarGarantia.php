                ...
                <form action="<?php echo current_url(); ?>" method="post" id="formGarantia">
                    ...
                    <div class="span12" style="padding: 1%; margin-left: 0">
                        <div class="span6 offset5" style="display:flex;justify-content: center">
                            ...
                            <a href="<?php echo base_url() ?>garantias" id="" class="button btn btn-mini btn-warning"><span class="button__icon"><i class="bx bx-undo"></i></span> <span class="button__text2">Voltar</span></a>
                        </div>
                    </div>
                </form>
                .
