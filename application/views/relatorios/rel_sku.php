...
<div class="row-fluid" style="margin-top: 0">
        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <ul style="flex-direction: row;" class="site-stats">
                    <li><a target="_blank" href="<?php echo base_url() ?>relatorios/skuRapid"><i class="fas fa-shopping-bag"></i> <small>SKU rápido - pdf</small></a></li>
                    <li><a target="_blank" href="<?php echo base_url() ?>relatorios/skuRapid?format=xls"><i class="fas fa-shopping-bag"></i> <small>SKU rápido - xls</small></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="span8">
        <div class="widget-box">
            ...
            <div class="widget-content">
                <form target="_blank" action="<?php echo base_url() ?>relatorios/skuCustom" method="get">
