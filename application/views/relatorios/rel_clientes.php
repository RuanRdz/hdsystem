        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <ul style="flex-direction: row;" class="site-stats">
                    <li><a href="<?php echo base_url() ?>relatorios/clientesRapid" target="_blank"><i
                                    class="fas fa-users"></i> <small>Todos os Clientes - pdf</small></a></li>
                    <li><a href="<?php echo base_url() ?>relatorios/clientesRapid?format=xls" target="_blank"><i
        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <div class="span12 well">
                    <form target="_blank" action="<?php echo base_url() ?>relatorios/clientesCustom"
                          method="get">
                        <div class="span4">
