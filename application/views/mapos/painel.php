        ...
        <div class="new-statisc">
            <div class="widget-box-new widbox-blak" style="height:100%">
                ...
                <div class="new-bottons">
                    <a href="<?php echo base_url(); ?>clientes/adicionar" class="card tip-top" title="Add Clientes e Fornecedores">
                    ...
                    <a href="<?php echo base_url(); ?>produtos/adicionar" class="card tip-top" title="Adicionar Produtos">
                    ...
                    <a href="<?php echo base_url() ?>servicos/adicionar" class="card tip-top" title="Adicionar serviços">
                    ...
                    <a href="<?php echo base_url(); ?>os/adicionar" class="card tip-top" title="Adicionar OS">
                    ...
                    <a href="<?php echo base_url(); ?>garantias" class="card tip-top" title="Adicionar garantia">
                    ...
                    <a href="<?php echo base_url() ?>vendas/adicionar" class="card tip-top" title="Adicionar Vendas">
                    ...
                    <?php if ($estatisticas_financeiro != null) {
                        if ($estatisticas_financeiro->total_receita != null || $estatisticas_financeiro->total_despesa != null || $estatisticas_financeiro->total_receita_pendente != null || $estatisticas_financeiro->total_despesa_pendente != null) {  ?>
                            ...
                            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'rFinanceiro')) : ?>
                                ...
                                <a href="<?php echo base_url() ?>financeiro/lancamentos" class="card tip-top" title="Adicionar receita">
                                ...
                                <a href="<?php echo base_url() ?>financeiro/lancamentos" class="card tip-top" title="Adiciona despesa">
    ...
    $(document).ready(function() {
        ...
        var srcCalendar = new FullCalendar.Calendar(srcCalendarEl, {
            ...
            eventClick: function(info) {
                ...
                $('#modalIdVisualizar').attr("href", "<?php echo base_url(); ?>os/visualizar/" + eventObj.id);
                if (eventObj.editar) {
                    $('#modalIdEditar').show();
                    $('#linkExcluir').show();
                    $('#modalIdEditar').attr("href", "<?php echo base_url(); ?>os/editar/" + eventObj.id);
